...
func (FlowMessage_FlowType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_flow_messages_enriched_3309a2b1b14caa0e, []int{0, 0}
}
...
func (FlowMessage_IPType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_flow_messages_enriched_3309a2b1b14caa0e, []int{0, 1}
}
...
func (FlowMessage_DirectionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_flow_messages_enriched_3309a2b1b14caa0e, []int{0, 2}
}
...
func (FlowMessage_NormalizedType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_flow_messages_enriched_3309a2b1b14caa0e, []int{0, 3}
}
...
func (*FlowMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_flow_messages_enriched_3309a2b1b14caa0e, []int{0}
}
...
func init() {
	proto.RegisterFile("flow-messages-enriched.proto", fileDescriptor_flow_messages_enriched_3309a2b1b14caa0e)
}

var fileDescriptor_flow_messages_enriched_3309a2b1b14caa0e = []byte{
	// 743 bytes of a gzipped FileDescriptorProto
	,
}
