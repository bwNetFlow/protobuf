...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_flow_2dmessages_2denriched_2eproto 
...
enum FlowMessage_FlowType {
  ...
  FlowMessage_FlowType_FlowMessage_FlowType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  FlowMessage_FlowType_FlowMessage_FlowType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum FlowMessage_IPType {
  ...
  FlowMessage_IPType_FlowMessage_IPType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  FlowMessage_IPType_FlowMessage_IPType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum FlowMessage_DirectionType {
  ...
  FlowMessage_DirectionType_FlowMessage_DirectionType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  FlowMessage_DirectionType_FlowMessage_DirectionType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum FlowMessage_NormalizedType {
  ...
  FlowMessage_NormalizedType_FlowMessage_NormalizedType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  FlowMessage_NormalizedType_FlowMessage_NormalizedType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class FlowMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flowmessageenriched.FlowMessage) */ {
 public:
  FlowMessage();
  virtual ~FlowMessage();
 ...
 private:
  ...
  friend struct ::protobuf_flow_2dmessages_2denriched_2eproto::TableStruct;
};
// ===================================================================
...
inline void FlowMessage::clear_samplingrate() {
  samplingrate_ = GOOGLE_ULONGLONG(0);
}
